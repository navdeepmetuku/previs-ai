...
/**
 * HeroClient — client-side hero page with scroll animation.
 *
 * Wraps the full landing page content. The scroll animation
 * (HeroScrollScene) runs first, then reveals the main content
 * after the camera flash at stage 6.
 */
...
export default function HeroClient() {
  ...
  return (
    <>
      {/* Scroll animation — occupies 7×100vh, then fires onReveal */}
      {!revealed && <HeroScrollScene onReveal={() => setRevealed(true)} />}

      {/* Main page — hidden until flash reveal, then fades in */}
      <div style={{
    ...
    <div className="min-h-screen bg-[#07070f] text-white flex flex-col overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0" aria-hidden>
        <div className="absolute inset-0"
          style={{ background: "radial-gradient(ellipse at 50% 20%, rgba(14,10,28,0.9) 0%, #07070f 65%)" }} />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[280px]"
          style={{ background: "radial-gradient(ellipse at center top, rgba(232,184,75,0.07) 0%, transparent 70%)" }} />
      ...
      <section className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 pt-20 pb-10 text-center">
        ...
        <h1 className="max-w-4xl text-[42px] sm:text-6xl lg:text-7xl font-black leading-[1.04] tracking-tight animate-fade-up">
          ...
          <span style={{
            background: "linear-gradient(92deg, #e8b84b 0%, #f59e0b 40%, #e8b84b 100%)",
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-3 items-center animate-fade-up" style={{ animationDelay: "160ms" }}>
          <Link href="/studio"
            ...
            style={{ boxShadow: "0 0 48px rgba(232,184,75,0.28)" }}>
            Start Storyboarding
          ...
          <div className="rounded-xl overflow-hidden"
            ...
            <div className="p-4">
              ...
              <div className="mt-3 flex items-start gap-2.5 rounded-md px-3 py-2.5"
                style={{ background: "rgba(232,184,75,0.05)", border: "1px solid rgba(232,184,75,0.10)" }}>
      ...
      <section className="relative z-10 border-t border-white/[0.04] px-4 py-20 text-center">
        ...
        <Link href="/studio"
          ...
          style={{ boxShadow: "0 0 60px rgba(232,184,75,0.24)" }}>
...
const DEMO_FRAMES = [
  ...
  { title: "Final Standoff",     shot: "MS",    mood: "Mysterious", moodCls: "bg-indigo-900/70 text-indigo-300", bg: "linear-gradient(135deg,#020208,#080618,#020208)" },
];
